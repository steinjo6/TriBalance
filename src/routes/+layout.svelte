...
<div class="layout-root">
    <nav class="sidebar">
        <div
            style="font-weight:700; font-size:1.25rem; margin-bottom:1.5rem; padding:0.5rem;"
        >
            TriBalance
        </div>
...
<style>
    ...
    @media (max-width: 639px) {
        ...
        .main {
            padding: 1rem;
            padding-bottom: 5rem;
        } /* Mehr Abstand unten, damit Inhalt nicht verdeckt wird */
