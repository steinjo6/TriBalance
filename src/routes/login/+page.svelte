    ...
    <div class="max-w-md mx-auto card p-8 variant-glass-surface">
        ...
        >
            <label class="field">
                ...
                <input type="text" name="username" autocomplete="username" required class="input w-full" oninput={() => { form = null; }} />
            </label>

            <label class="field">
                <span class="small">Passwort</span>
                <input type="password" name="password" autocomplete="current-password" required class="input w-full" oninput={() => { form = null; }} />
            </label>
