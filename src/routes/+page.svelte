<div class="page-wrapper">
    <div class="header-section">
        <h1 class="h1">Willkommen bei TriBalance</h1>
        <p class="subtext">Tracke deine Leistung und behalte deine mentale Verfassung im Blick.</p>
    </div>

    <div class="main-card text-center">
        <div style="display:flex;justify-content:center;gap:1rem;">
            <a href="/dashboard" class="primary-btn" style="background:#e2e8f0;color:#0f172a;">Zum Dashboard</a>
            <a href="/trainings" class="primary-btn">Training starten</a>
        </div>
    </div>
</div>
...
<style>
    ...
    .primary-btn { display:inline-block; padding:0.9rem 1rem; background:#3b82f6; color:#fff; border-radius:10px; text-decoration:none; font-weight:700; }
    .primary-btn[style] { padding:0.75rem 1rem; }
</style>